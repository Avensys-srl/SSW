...
export interface UiMessages {
  ...
  preselection: {
    ...
    maximumLevel: string;
    soundQuantity: string;
    soundPowerLevel: string;
    soundPressureLevel: string;
    distance: string;
    directivityFactor: string;
    enableCriterion: string;
  };
  unit: {
    selected: string;
    catalogue: string;
  ...
  co2Sound: {
    ...
    useProfile: string;
    activity: string;
    occupiedPeople: string;
    occupiedMinutes: string;
    breakPeople: string;
    breakMinutes: string;
    calculationMethod: string;
    maximumConcentrationMethod: string;
    fixedAirflowMethod: string;
    personAndAreaMethod: string;
    outdoorConcentration: string;
    maximumConcentration: string;
    airflowPerArea: string;
    airflowPerPerson: string;
    co2Results: string;
    roomArea: string;
    roomVolume: string;
    co2Generation: string;
    requiredOutdoorAirflow: string;
    calculatedMaximumConcentration: string;
    soundTitle: string;
    soundDescription: string;
    includeSoundInReport: string;
    directivityFactor: string;
    firstDistance: string;
    secondDistance: string;
    iso16032: string;
    spectralResults: string;
    airPath: string;
    weightedSoundPower: string;
    soundPressureAtDistance: string;
    breakoutNoise: string;
    awaitingBackendResults: string;
  };
  documents: {
