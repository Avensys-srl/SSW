...
const lexicons: Record<LanguageCode, UiLexicon> = {
  ...
  bg: {
    ...
    dutyPoint: "Работна точка", supplyAirflow: "Дебит подаване", extractAirflow: "Дебит връщане", staticPressure: "Статично налягане", results: "Резултати от търсенето", compatibleUnits: "съвместими агрегати", orderedByFit: "подредени по съответствие", technicalFit: "Техническо съответствие", calculateAfterSelection: "След избора", recommended: "Препоръчано", selected: "Избрано", catalogue: "Каталог", maximumAirflow: "Максимален дебит", availablePressure: "Налично налягане", nominalEfficiency: "Номинална ефективност", soundPower: "Звукова мощност", currentUnit: "Текущ агрегат", chooseUnit: "Избери агрегат",
  ...
  da: {
    ...
    dutyPoint: "Driftspunkt", supplyAirflow: "Tilluftsmængde", extractAirflow: "Returluftsmængde", staticPressure: "Statisk tryk", results: "Søgeresultater", compatibleUnits: "kompatible aggregater", orderedByFit: "sorteret efter egnethed", technicalFit: "Teknisk match", calculateAfterSelection: "Efter valg", recommended: "Anbefalet", selected: "Valgt", catalogue: "Katalog", maximumAirflow: "Maksimal luftmængde", availablePressure: "Tilgængeligt tryk", nominalEfficiency: "Nominel virkningsgrad", soundPower: "Lydeffekt", currentUnit: "Aktuelt aggregat", chooseUnit: "Vælg aggregat",
  ...
  de: {
    ...
    dutyPoint: "Betriebspunkt", supplyAirflow: "Zuluftvolumenstrom", extractAirflow: "Abluftvolumenstrom", staticPressure: "Statischer Druck", results: "Suchergebnisse", compatibleUnits: "kompatible Geräte", orderedByFit: "nach Eignung sortiert", technicalFit: "Technische Eignung", calculateAfterSelection: "Nach der Auswahl", recommended: "Empfohlen", selected: "Ausgewählt", catalogue: "Katalog", maximumAirflow: "Maximaler Volumenstrom", availablePressure: "Verfügbarer Druck", nominalEfficiency: "Nennwirkungsgrad", soundPower: "Schallleistung", currentUnit: "Aktuelles Gerät", chooseUnit: "Gerät wählen",
  ...
  hu: {
    ...
    dutyPoint: "Munkapont", supplyAirflow: "Befúvó légszállítás", extractAirflow: "Elszívó légszállítás", staticPressure: "Statikus nyomás", results: "Keresési eredmények", compatibleUnits: "kompatibilis egység", orderedByFit: "alkalmasság szerint", technicalFit: "Műszaki illeszkedés", calculateAfterSelection: "Kiválasztás után", recommended: "Ajánlott", selected: "Kiválasztva", catalogue: "Katalógus", maximumAirflow: "Maximális légszállítás", availablePressure: "Elérhető nyomás", nominalEfficiency: "Névleges hatásfok", soundPower: "Hangteljesítmény", currentUnit: "Aktuális egység", chooseUnit: "Egység választása",
  ...
  is: {
    ...
    dutyPoint: "Vinnupunktur", supplyAirflow: "Innblástursflæði", extractAirflow: "Frásogsflæði", staticPressure: "Stöðuþrýstingur", results: "Leitarniðurstöður", compatibleUnits: "samhæfar einingar", orderedByFit: "raðað eftir hentugleika", technicalFit: "Tæknilegt samræmi", calculateAfterSelection: "Eftir val", recommended: "Mælt með", selected: "Valin", catalogue: "Vörulisti", maximumAirflow: "Hámarksloftflæði", availablePressure: "Tiltækur þrýstingur", nominalEfficiency: "Nafnnýtni", soundPower: "Hljóðafl", currentUnit: "Núverandi eining", chooseUnit: "Velja einingu",
  ...
  no: {
    ...
    dutyPoint: "Driftspunkt", supplyAirflow: "Tilluftsmengde", extractAirflow: "Avtrekksmengde", staticPressure: "Statisk trykk", results: "Søkeresultater", compatibleUnits: "kompatible aggregater", orderedByFit: "sortert etter egnethet", technicalFit: "Teknisk treff", calculateAfterSelection: "Etter valg", recommended: "Anbefalt", selected: "Valgt", catalogue: "Katalog", maximumAirflow: "Maksimal luftmengde", availablePressure: "Tilgjengelig trykk", nominalEfficiency: "Nominell virkningsgrad", soundPower: "Lydeffekt", currentUnit: "Gjeldende aggregat", chooseUnit: "Velg aggregat",
  ...
  pl: {
    ...
    dutyPoint: "Punkt pracy", supplyAirflow: "Przepływ nawiewu", extractAirflow: "Przepływ wywiewu", staticPressure: "Ciśnienie statyczne", results: "Wyniki wyszukiwania", compatibleUnits: "kompatybilne urządzenia", orderedByFit: "uporządkowane wg dopasowania", technicalFit: "Dopasowanie techniczne", calculateAfterSelection: "Po wyborze", recommended: "Zalecane", selected: "Wybrano", catalogue: "Katalog", maximumAirflow: "Maksymalny przepływ", availablePressure: "Dostępne ciśnienie", nominalEfficiency: "Sprawność nominalna", soundPower: "Moc akustyczna", currentUnit: "Bieżące urządzenie", chooseUnit: "Wybierz urządzenie",
  ...
  sv: {
    ...
    dutyPoint: "Driftpunkt", supplyAirflow: "Tilluftsflöde", extractAirflow: "Frånluftsflöde", staticPressure: "Statiskt tryck", results: "Sökresultat", compatibleUnits: "kompatibla aggregat", orderedByFit: "sorterade efter lämplighet", technicalFit: "Teknisk matchning", calculateAfterSelection: "Efter val", recommended: "Rekommenderad", selected: "Vald", catalogue: "Katalog", maximumAirflow: "Maximalt luftflöde", availablePressure: "Tillgängligt tryck", nominalEfficiency: "Nominell verkningsgrad", soundPower: "Ljudeffekt", currentUnit: "Aktuellt aggregat", chooseUnit: "Välj aggregat",
