...
Public NotInheritable Class CLHelpForm
    ...
    Private Shared ReadOnly TopicDefinitions As HelpTopicDefinition() = {
        ...
        Topic("Help_Topic_FollowUps", "Follow-up reminders", "When preparing an email for a selection or project, SSW can schedule a customer follow-up from 1 to 90 days; the default is 7 days. The reminder starts only after the Outlook draft has been prepared successfully." & vbCrLf & vbCrLf & "The bell opens reminders that are due, upcoming or closed. Double-click a reminder to reopen its local selection or project. You can close it as successful or unsuccessful, reschedule it, or cancel it. Reminders belong only to this Windows installation; offline changes are saved locally and synchronized later."),
