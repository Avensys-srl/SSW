...
const seasonalConditionMessages: Record<LanguageCode, SeasonalConditionMessages> = {
  en: { regulationPercent: "Regulation level", seasonalConditions: "Seasonal conditions", summerEnabled: "Enable summer", imbalance: "Imbalance", winter: "Winter", summer: "Summer", outdoorTemperature: "Outdoor temp.", outdoorRelativeHumidity: "Outdoor R.H.", returnTemperature: "Return temp.", returnRelativeHumidity: "Return R.H." },
  bg: { regulationPercent: "Ниво на регулиране", seasonalConditions: "Сезонни условия", summerEnabled: "Активирай лято", imbalance: "Дисбаланс", winter: "Зима", summer: "Лято", outdoorTemperature: "Външна темп.", outdoorRelativeHumidity: "Външна отн. влажност", returnTemperature: "Темп. връщане", returnRelativeHumidity: "Отн. влажност връщане" },
  cs: { regulationPercent: "Úroveň regulace", seasonalConditions: "Sezónní podmínky", summerEnabled: "Aktivovat léto", imbalance: "Nevyváženost", winter: "Zima", summer: "Léto", outdoorTemperature: "Venkovní teplota", outdoorRelativeHumidity: "Venkovní rel. vlhkost", returnTemperature: "Teplota odváděného vzduchu", returnRelativeHumidity: "Rel. vlhkost odváděného vzduchu" },
  da: { regulationPercent: "Reguleringsniveau", seasonalConditions: "Sæsonbetingelser", summerEnabled: "Aktivér sommer", imbalance: "Ubalance", winter: "Vinter", summer: "Sommer", outdoorTemperature: "Udetemperatur", outdoorRelativeHumidity: "Ude-RF", returnTemperature: "Returtemperatur", returnRelativeHumidity: "Retur-RF" },
  de: { regulationPercent: "Regelungsniveau", seasonalConditions: "Saisonbedingungen", summerEnabled: "Sommer aktivieren", imbalance: "Ungleichgewicht", winter: "Winter", summer: "Sommer", outdoorTemperature: "Außentemperatur", outdoorRelativeHumidity: "Außen-R.F.", returnTemperature: "Ablufttemperatur", returnRelativeHumidity: "Abluft-R.F." },
  fr: { regulationPercent: "Niveau de régulation", seasonalConditions: "Conditions saisonnières", summerEnabled: "Activer l’été", imbalance: "Déséquilibre", winter: "Hiver", summer: "Été", outdoorTemperature: "Temp. extérieure", outdoorRelativeHumidity: "H.R. extérieure", returnTemperature: "Temp. air repris", returnRelativeHumidity: "H.R. air repris" },
  hu: { regulationPercent: "Szabályozási szint", seasonalConditions: "Évszakos feltételek", summerEnabled: "Nyár engedélyezése", imbalance: "Légmennyiség-eltérés", winter: "Tél", summer: "Nyár", outdoorTemperature: "Külső hőm.", outdoorRelativeHumidity: "Külső relatív pára", returnTemperature: "Elszívott hőm.", returnRelativeHumidity: "Elszívott relatív pára" },
  is: { regulationPercent: "Stýristig", seasonalConditions: "Árstíðarskilyrði", summerEnabled: "Virkja sumar", imbalance: "Ójafnvægi", winter: "Vetur", summer: "Sumar", outdoorTemperature: "Útihiti", outdoorRelativeHumidity: "Rakastig útilofts", returnTemperature: "Hitastig frásogs", returnRelativeHumidity: "Rakastig frásogs" },
  it: { regulationPercent: "Livello di regolazione", seasonalConditions: "Condizioni stagionali", summerEnabled: "Abilita estate", imbalance: "Sbilanciamento", winter: "Inverno", summer: "Estate", outdoorTemperature: "Temp. aria esterna", outdoorRelativeHumidity: "U.R. aria esterna", returnTemperature: "Temp. aria di ripresa", returnRelativeHumidity: "U.R. aria di ripresa" },
  nl: { regulationPercent: "Regelniveau", seasonalConditions: "Seizoenscondities", summerEnabled: "Zomer inschakelen", imbalance: "Onbalans", winter: "Winter", summer: "Zomer", outdoorTemperature: "Buitentemperatuur", outdoorRelativeHumidity: "RV buitenlucht", returnTemperature: "Retourtemperatuur", returnRelativeHumidity: "RV retourlucht" },
  no: { regulationPercent: "Reguleringsnivå", seasonalConditions: "Sesongbetingelser", summerEnabled: "Aktiver sommer", imbalance: "Ubalanse", winter: "Vinter", summer: "Sommer", outdoorTemperature: "Utetemperatur", outdoorRelativeHumidity: "RF uteluft", returnTemperature: "Avtrekkstemperatur", returnRelativeHumidity: "RF avtrekksluft" },
  pl: { regulationPercent: "Poziom regulacji", seasonalConditions: "Warunki sezonowe", summerEnabled: "Włącz lato", imbalance: "Niezrównoważenie", winter: "Zima", summer: "Lato", outdoorTemperature: "Temp. zewnętrzna", outdoorRelativeHumidity: "Wilg. wzgl. zewn.", returnTemperature: "Temp. wywiewu", returnRelativeHumidity: "Wilg. wzgl. wywiewu" },
  ro: { regulationPercent: "Nivel de reglare", seasonalConditions: "Condiții sezoniere", summerEnabled: "Activează vara", imbalance: "Dezechilibru", winter: "Iarnă", summer: "Vară", outdoorTemperature: "Temp. exterioară", outdoorRelativeHumidity: "U.R. exterioară", returnTemperature: "Temp. aer extras", returnRelativeHumidity: "U.R. aer extras" },
  sl: { regulationPercent: "Stopnja regulacije", seasonalConditions: "Sezonski pogoji", summerEnabled: "Omogoči poletje", imbalance: "Neuravnoteženost", winter: "Zima", summer: "Poletje", outdoorTemperature: "Zunanja temp.", outdoorRelativeHumidity: "Zunanja rel. vlaga", returnTemperature: "Temp. odvodnega zraka", returnRelativeHumidity: "Rel. vlaga odvodnega zraka" },
  sv: { regulationPercent: "Regleringsnivå", seasonalConditions: "Säsongsförhållanden", summerEnabled: "Aktivera sommar", imbalance: "Obalans", winter: "Vinter", summer: "Sommar", outdoorTemperature: "Utetemperatur", outdoorRelativeHumidity: "RF uteluft", returnTemperature: "Frånluftstemperatur", returnRelativeHumidity: "RF frånluft" },
};
