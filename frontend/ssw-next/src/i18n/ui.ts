...
export const domainMessages: Record<LanguageCode, DomainMessages> = {
  ...
  cs: { installation: { ceiling: "Strop", floor: "Podlaha", wall: "Stěna", internal: "Interní", external: "Externí" }, airflow: { fresh: "Venkovní vzduch", return: "Odváděný vzduch", exhaust: "Odpadní vzduch", supply: "Přívodní vzduch" }, fluid: { water: "Voda", ethyleneGlycol: "Etylenglykol", propyleneGlycol: "Propylenglykol" } },
...
const seasonalConditionMessages: Record<LanguageCode, SeasonalConditionMessages> = {
  en: { regulationPercent: "Regulation level", seasonalConditions: "Seasonal conditions", summerEnabled: "Enable summer", imbalance: "Imbalance", winter: "Winter", summer: "Summer", outdoorTemperature: "Outdoor temp.", outdoorRelativeHumidity: "Outdoor R.H.", returnTemperature: "Return temp.", returnRelativeHumidity: "Return R.H.", supplyAirTemperature: "Supply air temperature" },
  bg: { regulationPercent: "Ниво на регулиране", seasonalConditions: "Сезонни условия", summerEnabled: "Активирай лято", imbalance: "Дисбаланс", winter: "Зима", summer: "Лято", outdoorTemperature: "Външна темп.", outdoorRelativeHumidity: "Външна отн. влажност", returnTemperature: "Темп. връщане", returnRelativeHumidity: "Отн. влажност връщане", supplyAirTemperature: "Температура на подавания въздух" },
  cs: { regulationPercent: "Úroveň regulace", seasonalConditions: "Sezónní podmínky", summerEnabled: "Aktivovat léto", imbalance: "Nevyváženost", winter: "Zima", summer: "Léto", outdoorTemperature: "Venkovní teplota", outdoorRelativeHumidity: "Venkovní rel. vlhkost", returnTemperature: "Teplota odváděného vzduchu", returnRelativeHumidity: "Rel. vlhkost odváděného vzduchu", supplyAirTemperature: "Teplota přiváděného vzduchu" },
  da: { regulationPercent: "Reguleringsniveau", seasonalConditions: "Sæsonbetingelser", summerEnabled: "Aktivér sommer", imbalance: "Ubalance", winter: "Vinter", summer: "Sommer", outdoorTemperature: "Udetemperatur", outdoorRelativeHumidity: "Ude-RF", returnTemperature: "Returtemperatur", returnRelativeHumidity: "Retur-RF", supplyAirTemperature: "Tillufttemperatur" },
  de: { regulationPercent: "Regelungsniveau", seasonalConditions: "Saisonbedingungen", summerEnabled: "Sommer aktivieren", imbalance: "Ungleichgewicht", winter: "Winter", summer: "Sommer", outdoorTemperature: "Außentemperatur", outdoorRelativeHumidity: "Außen-R.F.", returnTemperature: "Ablufttemperatur", returnRelativeHumidity: "Abluft-R.F.", supplyAirTemperature: "Zulufttemperatur" },
  fr: { regulationPercent: "Niveau de régulation", seasonalConditions: "Conditions saisonnières", summerEnabled: "Activer l’été", imbalance: "Déséquilibre", winter: "Hiver", summer: "Été", outdoorTemperature: "Temp. extérieure", outdoorRelativeHumidity: "H.R. extérieure", returnTemperature: "Temp. air repris", returnRelativeHumidity: "H.R. air repris", supplyAirTemperature: "Température de l’air soufflé" },
  hu: { regulationPercent: "Szabályozási szint", seasonalConditions: "Évszakos feltételek", summerEnabled: "Nyár engedélyezése", imbalance: "Légmennyiség-eltérés", winter: "Tél", summer: "Nyár", outdoorTemperature: "Külső hőm.", outdoorRelativeHumidity: "Külső relatív pára", returnTemperature: "Elszívott hőm.", returnRelativeHumidity: "Elszívott relatív pára", supplyAirTemperature: "Befúvó levegő hőmérséklete" },
  is: { regulationPercent: "Stýristig", seasonalConditions: "Árstíðarskilyrði", summerEnabled: "Virkja sumar", imbalance: "Ójafnvægi", winter: "Vetur", summer: "Sumar", outdoorTemperature: "Útihiti", outdoorRelativeHumidity: "Rakastig útilofts", returnTemperature: "Hitastig frásogs", returnRelativeHumidity: "Rakastig frásogs", supplyAirTemperature: "Hitastig innblásturslofts" },
  it: { regulationPercent: "Livello di regolazione", seasonalConditions: "Condizioni stagionali", summerEnabled: "Abilita estate", imbalance: "Sbilanciamento", winter: "Inverno", summer: "Estate", outdoorTemperature: "Temp. aria esterna", outdoorRelativeHumidity: "U.R. aria esterna", returnTemperature: "Temp. aria di ripresa", returnRelativeHumidity: "U.R. aria di ripresa", supplyAirTemperature: "Temperatura aria di mandata" },
  nl: { regulationPercent: "Regelniveau", seasonalConditions: "Seizoenscondities", summerEnabled: "Zomer inschakelen", imbalance: "Onbalans", winter: "Winter", summer: "Zomer", outdoorTemperature: "Buitentemperatuur", outdoorRelativeHumidity: "RV buitenlucht", returnTemperature: "Retourtemperatuur", returnRelativeHumidity: "RV retourlucht", supplyAirTemperature: "Toevoerluchttemperatuur" },
  no: { regulationPercent: "Reguleringsnivå", seasonalConditions: "Sesongbetingelser", summerEnabled: "Aktiver sommer", imbalance: "Ubalanse", winter: "Vinter", summer: "Sommer", outdoorTemperature: "Utetemperatur", outdoorRelativeHumidity: "RF uteluft", returnTemperature: "Avtrekkstemperatur", returnRelativeHumidity: "RF avtrekksluft", supplyAirTemperature: "Tilluftstemperatur" },
  pl: { regulationPercent: "Poziom regulacji", seasonalConditions: "Warunki sezonowe", summerEnabled: "Włącz lato", imbalance: "Niezrównoważenie", winter: "Zima", summer: "Lato", outdoorTemperature: "Temp. zewnętrzna", outdoorRelativeHumidity: "Wilg. wzgl. zewn.", returnTemperature: "Temp. wywiewu", returnRelativeHumidity: "Wilg. wzgl. wywiewu", supplyAirTemperature: "Temperatura nawiewu" },
  ro: { regulationPercent: "Nivel de reglare", seasonalConditions: "Condiții sezoniere", summerEnabled: "Activează vara", imbalance: "Dezechilibru", winter: "Iarnă", summer: "Vară", outdoorTemperature: "Temp. exterioară", outdoorRelativeHumidity: "U.R. exterioară", returnTemperature: "Temp. aer extras", returnRelativeHumidity: "U.R. aer extras", supplyAirTemperature: "Temperatura aerului introdus" },
  sl: { regulationPercent: "Stopnja regulacije", seasonalConditions: "Sezonski pogoji", summerEnabled: "Omogoči poletje", imbalance: "Neuravnoteženost", winter: "Zima", summer: "Poletje", outdoorTemperature: "Zunanja temp.", outdoorRelativeHumidity: "Zunanja rel. vlaga", returnTemperature: "Temp. odvodnega zraka", returnRelativeHumidity: "Rel. vlaga odvodnega zraka", supplyAirTemperature: "Temperatura dovodnega zraka" },
  sv: { regulationPercent: "Regleringsnivå", seasonalConditions: "Säsongsförhållanden", summerEnabled: "Aktivera sommar", imbalance: "Obalans", winter: "Vinter", summer: "Sommar", outdoorTemperature: "Utetemperatur", outdoorRelativeHumidity: "RF uteluft", returnTemperature: "Frånluftstemperatur", returnRelativeHumidity: "RF frånluft", supplyAirTemperature: "Tilluftstemperatur" },
};

type AdditionalSelectionMessages = Pick<
  UiMessages["preselection"],
  | "additionalCriteria"
  | "additionalCriteriaDescription"
  | "maximumSfp"
  | "supplyNoise"
  | "breakoutNoise"
  | "maximumLevel"
...
const additionalSelectionMessages: Record<LanguageCode, AdditionalSelectionMessages> = {
  en: { additionalCriteria: "Additional selection criteria", additionalCriteriaDescription: "Applied after the duty point and required regulation have been verified.", maximumSfp: "Maximum SFP", supplyNoise: "Maximum supply noise", breakoutNoise: "Maximum casing-radiated noise", maximumLevel: "Maximum level", soundQuantity: "Acoustic quantity", soundPowerLevel: "Sound power LwA", soundPressureLevel: "Sound pressure LpA", distance: "Distance", directivityFactor: "Directivity factor", enableCriterion: "Enable" },
  bg: { additionalCriteria: "Допълнителни критерии за подбор", additionalCriteriaDescription: "Прилагат се след проверка на работната точка и необходимото регулиране.", maximumSfp: "Максимален SFP", supplyNoise: "Максимален шум на подаване", breakoutNoise: "Максимален излъчен шум", maximumLevel: "Максимално ниво", soundQuantity: "Акустична величина", soundPowerLevel: "Звукова мощност LwA", soundPressureLevel: "Звуково налягане LpA", distance: "Разстояние", directivityFactor: "Фактор на насоченост", enableCriterion: "Активирай" },
  cs: { additionalCriteria: "Další kritéria výběru", additionalCriteriaDescription: "Použijí se po ověření pracovního bodu a požadované regulace.", maximumSfp: "Maximální SFP", supplyNoise: "Maximální hluk přívodu", breakoutNoise: "Maximální vyzařovaný hluk", maximumLevel: "Maximální hladina", soundQuantity: "Akustická veličina", soundPowerLevel: "Akustický výkon LwA", soundPressureLevel: "Akustický tlak LpA", distance: "Vzdálenost", directivityFactor: "Činitel směrovosti", enableCriterion: "Aktivovat" },
  da: { additionalCriteria: "Yderligere udvælgelseskriterier", additionalCriteriaDescription: "Anvendes efter kontrol af driftspunkt og nødvendig regulering.", maximumSfp: "Maksimal SFP", supplyNoise: "Maksimal tilluftsstøj", breakoutNoise: "Maksimal udstrålet støj", maximumLevel: "Maksimalt niveau", soundQuantity: "Akustisk størrelse", soundPowerLevel: "Lydeffekt LwA", soundPressureLevel: "Lydtryk LpA", distance: "Afstand", directivityFactor: "Retningsfaktor", enableCriterion: "Aktivér" },
  de: { additionalCriteria: "Zusätzliche Auswahlkriterien", additionalCriteriaDescription: "Werden nach Prüfung von Betriebspunkt und erforderlicher Regelung angewendet.", maximumSfp: "Maximaler SFP", supplyNoise: "Maximaler Zuluftschall", breakoutNoise: "Maximaler Gehäuseschall", maximumLevel: "Maximalpegel", soundQuantity: "Akustische Größe", soundPowerLevel: "Schallleistung LwA", soundPressureLevel: "Schalldruck LpA", distance: "Abstand", directivityFactor: "Richtfaktor", enableCriterion: "Aktivieren" },
  fr: { additionalCriteria: "Critères de sélection supplémentaires", additionalCriteriaDescription: "Appliqués après vérification du point de fonctionnement et de la régulation requise.", maximumSfp: "SFP maximal", supplyNoise: "Bruit de soufflage maximal", breakoutNoise: "Bruit rayonné maximal", maximumLevel: "Niveau maximal", soundQuantity: "Grandeur acoustique", soundPowerLevel: "Puissance acoustique LwA", soundPressureLevel: "Pression acoustique LpA", distance: "Distance", directivityFactor: "Facteur de directivité", enableCriterion: "Activer" },
  hu: { additionalCriteria: "További kiválasztási feltételek", additionalCriteriaDescription: "A munkapont és a szükséges szabályozás ellenőrzése után alkalmazva.", maximumSfp: "Maximális SFP", supplyNoise: "Maximális befúvási zaj", breakoutNoise: "Maximális kisugárzott zaj", maximumLevel: "Maximális szint", soundQuantity: "Akusztikai mennyiség", soundPowerLevel: "Hangteljesítmény LwA", soundPressureLevel: "Hangnyomás LpA", distance: "Távolság", directivityFactor: "Irányítottsági tényező", enableCriterion: "Engedélyezés" },
  is: { additionalCriteria: "Viðbótarvalskilyrði", additionalCriteriaDescription: "Beitt eftir að vinnupunktur og nauðsynleg stýring hafa verið staðfest.", maximumSfp: "Hámarks SFP", supplyNoise: "Hámarks hljóð í innblæstri", breakoutNoise: "Hámarks útgeislaður hávaði", maximumLevel: "Hámarksstig", soundQuantity: "Hljóðstærð", soundPowerLevel: "Hljóðafl LwA", soundPressureLevel: "Hljóðþrýstingur LpA", distance: "Fjarlægð", directivityFactor: "Stefnustuðull", enableCriterion: "Virkja" },
  it: { additionalCriteria: "Criteri aggiuntivi di selezione", additionalCriteriaDescription: "Applicati dopo la verifica del punto di lavoro e della regolazione necessaria.", maximumSfp: "SFP massimo", supplyNoise: "Rumore massimo di mandata", breakoutNoise: "Rumore massimo irradiato", maximumLevel: "Livello massimo", soundQuantity: "Grandezza acustica", soundPowerLevel: "Potenza sonora LwA", soundPressureLevel: "Pressione sonora LpA", distance: "Distanza", directivityFactor: "Fattore di direttività", enableCriterion: "Attiva" },
  nl: { additionalCriteria: "Aanvullende selectiecriteria", additionalCriteriaDescription: "Toegepast nadat werkpunt en vereiste regeling zijn gecontroleerd.", maximumSfp: "Maximale SFP", supplyNoise: "Maximaal toevoergeluid", breakoutNoise: "Maximaal uitgestraald geluid", maximumLevel: "Maximaal niveau", soundQuantity: "Akoestische grootheid", soundPowerLevel: "Geluidsvermogen LwA", soundPressureLevel: "Geluidsdruk LpA", distance: "Afstand", directivityFactor: "Richtingsfactor", enableCriterion: "Inschakelen" },
  no: { additionalCriteria: "Ytterligere utvalgskriterier", additionalCriteriaDescription: "Brukes etter at driftspunkt og nødvendig regulering er kontrollert.", maximumSfp: "Maksimal SFP", supplyNoise: "Maksimal tilluftsstøy", breakoutNoise: "Maksimal utstrålt støy", maximumLevel: "Maksimalt nivå", soundQuantity: "Akustisk størrelse", soundPowerLevel: "Lydeffekt LwA", soundPressureLevel: "Lydtrykk LpA", distance: "Avstand", directivityFactor: "Retningsfaktor", enableCriterion: "Aktiver" },
  pl: { additionalCriteria: "Dodatkowe kryteria doboru", additionalCriteriaDescription: "Stosowane po sprawdzeniu punktu pracy i wymaganej regulacji.", maximumSfp: "Maksymalny SFP", supplyNoise: "Maksymalny hałas nawiewu", breakoutNoise: "Maksymalny hałas emitowany", maximumLevel: "Poziom maksymalny", soundQuantity: "Wielkość akustyczna", soundPowerLevel: "Moc akustyczna LwA", soundPressureLevel: "Ciśnienie akustyczne LpA", distance: "Odległość", directivityFactor: "Współczynnik kierunkowości", enableCriterion: "Włącz" },
  ro: { additionalCriteria: "Criterii suplimentare de selecție", additionalCriteriaDescription: "Aplicate după verificarea punctului de lucru și a reglajului necesar.", maximumSfp: "SFP maxim", supplyNoise: "Zgomot maxim de introducere", breakoutNoise: "Zgomot radiat maxim", maximumLevel: "Nivel maxim", soundQuantity: "Mărime acustică", soundPowerLevel: "Putere acustică LwA", soundPressureLevel: "Presiune acustică LpA", distance: "Distanță", directivityFactor: "Factor de directivitate", enableCriterion: "Activează" },
  sl: { additionalCriteria: "Dodatna merila izbire", additionalCriteriaDescription: "Uporabijo se po preverjanju delovne točke in potrebne regulacije.", maximumSfp: "Največji SFP", supplyNoise: "Največji hrup dovoda", breakoutNoise: "Največji sevani hrup", maximumLevel: "Največja raven", soundQuantity: "Akustična veličina", soundPowerLevel: "Zvočna moč LwA", soundPressureLevel: "Zvočni tlak LpA", distance: "Razdalja", directivityFactor: "Faktor usmerjenosti", enableCriterion: "Omogoči" },
...
const lexicons: Record<LanguageCode, UiLexicon> = {
  en: {
    ...
    airflowConfiguration: "Airflow configuration", defaultHint: "Recommended default for the selected installation.", orientation: "Airflow orientation", upperAccess: "Upper access", lowerAccess: "Lower access", frontAccess: "Front access", accessPanel: "Access panel",
  ...
  it: {
    ...
    airflowConfiguration: "Configurazione flussi", defaultHint: "Default consigliato per l'installazione selezionata.", orientation: "Orientamento flussi", upperAccess: "Accesso superiore", lowerAccess: "Accesso inferiore", frontAccess: "Accesso frontale", accessPanel: "Pannello di accesso",
  ...
  bg: {
    ...
    airflowConfiguration: "Конфигурация на потоците", defaultHint: "Препоръчана стойност за избрания монтаж.", orientation: "Ориентация на потоците", upperAccess: "Горен достъп", lowerAccess: "Долен достъп", frontAccess: "Преден достъп", accessPanel: "Сервизен панел",
  ...
  cs: {
    notifications: "Centrum oznámení", components: "Komponenty UI", currentSelection: "Aktuální výběr", saveDraft: "Uložit koncept", noUnit: "Žádná jednotka", supply: "Přívod", extract: "Odvod", pressure: "Tlak", layout: "Uspořádání", efficiency: "Účinnost", margin: "Rezerva", power: "Výkon",
    projectData: "Údaje projektu", projectName: "Název projektu", customerReference: "Reference zákazníka", freeReference: "Volná reference", documentLanguage: "Jazyk dokumentů", projectStatus: "Stav projektu", technicalReference: "Technická reference", registered: "Registrováno", revision: "Revize", current: "Aktuální", lastSaved: "Naposledy uloženo", today: "Dnes", local: "Místní",
    dutyPoint: "Pracovní bod", supplyAirflow: "Průtok přívodu", extractAirflow: "Průtok odvodu", staticPressure: "Statický tlak", results: "Výsledky hledání", compatibleUnits: "kompatibilních jednotek", orderedByFit: "SFP ↑", technicalFit: "Požadovaná regulace", calculateAfterSelection: "Po výběru", recommended: "Doporučeno", selected: "Vybráno", catalogue: "Katalog", maximumAirflow: "Maximální průtok", availablePressure: "Dostupný tlak", nominalEfficiency: "Jmenovitá účinnost", soundPower: "Akustický výkon", currentUnit: "Aktuální jednotka", chooseUnit: "Vybrat jednotku",
    airflowConfiguration: "Konfigurace proudění", defaultHint: "Doporučené výchozí nastavení pro zvolenou instalaci.", orientation: "Směr proudění", upperAccess: "Přístup shora", lowerAccess: "Přístup zespodu", frontAccess: "Přístup zepředu", accessPanel: "Servisní panel",
    enableCoil: "Aktivovat výměník", calculationMode: "Režim výpočtu", coil: "Výměník", fluid: "Médium", glycol: "Glykol", coolingIn: "Chlazení – vstup", coolingOut: "Chlazení – výstup", heatingIn: "Ohřev – vstup", heatingOut: "Ohřev – výstup", rows: "řady", circuits: "okruhy", finSpacing: "rozteč lamel", performance: "Vypočtené parametry", enableToCalculate: "Aktivujte výměník, aby bylo možné vypočítat jeho parametry.", noneAssociated: "K této jednotce není v místní databázi přiřazen žádný výměník.", additionalPressureDrop: "Dodatečná tlaková ztráta použitá na křivce", capacity: "Výkon", airOut: "Výstupní vzduch", airPressureDrop: "Tlaková ztráta vzduchu",
    preheating: "Elektrický předehřev", postHeating: "Elektrický dohřev", heater: "Elektrický ohřívač", voltagePhases: "Napětí / fáze", currentValue: "Proud", airIn: "Vstupní vzduch", maximumAirOut: "Max. teplota výstupního vzduchu", relativeHumidityOut: "Výstupní rel. vlhkost", searchPlaceholder: "Hledat kód nebo popis", allCategories: "Všechny kategorie", selectedCount: "vybráno", code: "Kód", description: "Popis", category: "Kategorie",
    technicalSheet: "Obchodní list", technicalSheetDescription: "Výkonové údaje a konfigurace", installationManual: "Návod k instalaci", installationManualDescription: "Instalace, připojení a údržba", euDeclaration: "Prohlášení EU", euDeclarationDescription: "Shoda a použitelné normy", dimensionalDrawing: "Rozměrový výkres", dimensionalDrawingDescription: "Celkové rozměry a rozměry konfigurace", localPackageNotice: "Dostupnost a vytváření dokumentů řídí místní výrobní postup podle modelu, konfigurace a jazyka.", offlineAvailable: "K dispozici offline", openDocument: "Otevřít dokument",
    readyForReport: "Výběr je připraven k vytvoření technické zprávy.", reference: "Reference", requestedPressure: "Požadovaný tlak", options: "Možnosti", notSelectedFeminine: "Nevybráno", notSelectedMasculine: "Nevybráno", technicalReport: "Technická zpráva", reportDescription: "Dokument použije jazyk a referenci aktuálního projektu.",
    completeSave: "Dokončete ukládání v otevřeném produkčním rozhraní.", draftSavedAt: "Koncept uložen v", completeReport: "Dokončete vytvoření zprávy v otevřeném produkčním rozhraní.", reportReady: "Zpráva je připravena",
  },
  da: {
    ...
    airflowConfiguration: "Luftstrømskonfiguration", defaultHint: "Anbefalet standard for den valgte installation.", orientation: "Luftstrømsretning", upperAccess: "Adgang ovenfra", lowerAccess: "Adgang nedefra", frontAccess: "Adgang forfra", accessPanel: "Servicepanel",
    ...
    technicalSheet: "Handelsblad", technicalSheetDescription: "Ydelsesdata og konfiguration", installationManual: "Installationsvejledning", installationManualDescription: "Montage, tilslutninger og vedligeholdelse", euDeclaration: "EU-erklæring", euDeclarationDescription: "Overensstemmelse og gældende standarder", dimensionalDrawing: "Måltegning", dimensionalDrawingDescription: "Ydre mål og konfigurationsmål", localPackageNotice: "Tilgængelighed og generering styres af den lokale produktionsproces ud fra model, konfiguration og sprog.", offlineAvailable: "Tilgængelig offline", openDocument: "Åbn dokument",
  ...
  de: {
    ...
    airflowConfiguration: "Luftstromkonfiguration", defaultHint: "Empfohlener Standard für die gewählte Installation.", orientation: "Luftstromausrichtung", upperAccess: "Zugang oben", lowerAccess: "Zugang unten", frontAccess: "Zugang vorne", accessPanel: "Zugangspaneel",
  ...
  fr: {
    ...
    airflowConfiguration: "Configuration des flux", defaultHint: "Valeur par défaut recommandée pour l'installation.", orientation: "Orientation des flux", upperAccess: "Accès supérieur", lowerAccess: "Accès inférieur", frontAccess: "Accès frontal", accessPanel: "Panneau d'accès",
    ...
    technicalSheet: "Documentation commerciale", technicalSheetDescription: "Performances et configuration", installationManual: "Manuel d'installation", installationManualDescription: "Montage, raccordements et maintenance", euDeclaration: "Déclaration UE", euDeclarationDescription: "Conformité et normes applicables", dimensionalDrawing: "Plan dimensionnel", dimensionalDrawingDescription: "Encombrements et cotes de la configuration", localPackageNotice: "La disponibilité et la génération sont gérées par le workflow de production local selon le modèle, la configuration et la langue.", offlineAvailable: "Disponible hors ligne", openDocument: "Ouvrir le document",
  ...
  hu: {
    ...
    airflowConfiguration: "Légáram-konfiguráció", defaultHint: "A kiválasztott telepítés ajánlott alapértéke.", orientation: "Légáram iránya", upperAccess: "Felső hozzáférés", lowerAccess: "Alsó hozzáférés", frontAccess: "Elülső hozzáférés", accessPanel: "Hozzáférési panel",
  ...
  is: {
    ...
    airflowConfiguration: "Loftflæðisstilling", defaultHint: "Ráðlagt sjálfgefið gildi fyrir uppsetninguna.", orientation: "Stefna loftflæðis", upperAccess: "Aðgangur að ofan", lowerAccess: "Aðgangur að neðan", frontAccess: "Aðgangur að framan", accessPanel: "Þjónustulúga",
  ...
  nl: {
    ...
    airflowConfiguration: "Luchtstroomconfiguratie", defaultHint: "Aanbevolen standaard voor de gekozen installatie.", orientation: "Luchtstroomrichting", upperAccess: "Toegang bovenzijde", lowerAccess: "Toegang onderzijde", frontAccess: "Toegang voorzijde", accessPanel: "Toegangspaneel",
  ...
  no: {
    ...
    airflowConfiguration: "Luftstrømskonfigurasjon", defaultHint: "Anbefalt standard for valgt installasjon.", orientation: "Luftstrømretning", upperAccess: "Tilgang ovenfra", lowerAccess: "Tilgang nedenfra", frontAccess: "Tilgang forfra", accessPanel: "Tilgangspanel",
    ...
    technicalSheet: "Kommersielt ark", technicalSheetDescription: "Ytelsesdata og konfigurasjon", installationManual: "Installasjonshåndbok", installationManualDescription: "Montering, tilkoblinger og vedlikehold", euDeclaration: "EU-erklæring", euDeclarationDescription: "Samsvar og gjeldende standarder", dimensionalDrawing: "Måltegning", dimensionalDrawingDescription: "Utvendige mål og konfigurasjonsmål", localPackageNotice: "Tilgjengelighet og generering styres av den lokale produksjonsflyten ut fra modell, konfigurasjon og språk.", offlineAvailable: "Tilgjengelig frakoblet", openDocument: "Åpne dokument",
  ...
  pl: {
    ...
    airflowConfiguration: "Konfiguracja przepływów", defaultHint: "Zalecane ustawienie dla wybranego montażu.", orientation: "Orientacja przepływów", upperAccess: "Dostęp od góry", lowerAccess: "Dostęp od dołu", frontAccess: "Dostęp od przodu", accessPanel: "Panel dostępu",
  ...
  ro: {
    ...
    airflowConfiguration: "Configurația fluxurilor", defaultHint: "Valoare implicită recomandată pentru instalarea aleasă.", orientation: "Orientarea fluxurilor", upperAccess: "Acces superior", lowerAccess: "Acces inferior", frontAccess: "Acces frontal", accessPanel: "Panou de acces",
  ...
  sl: {
    ...
    airflowConfiguration: "Konfiguracija pretokov", defaultHint: "Priporočena privzeta vrednost za izbrano namestitev.", orientation: "Usmeritev pretokov", upperAccess: "Dostop zgoraj", lowerAccess: "Dostop spodaj", frontAccess: "Dostop spredaj", accessPanel: "Dostopni panel",
    ...
    technicalSheet: "Komercialni izpis", technicalSheetDescription: "Zmogljivosti in konfiguracija", installationManual: "Navodila za namestitev", installationManualDescription: "Montaža, priključki in vzdrževanje", euDeclaration: "Izjava EU", euDeclarationDescription: "Skladnost in veljavni standardi", dimensionalDrawing: "Dimenzijska risba", dimensionalDrawingDescription: "Gabariti in mere konfiguracije", localPackageNotice: "Razpoložljivost in izdelavo upravlja lokalni proizvodni potek glede na model, konfiguracijo in jezik.", offlineAvailable: "Na voljo brez povezave", openDocument: "Odpri dokument",
  ...
  sv: {
    ...
    airflowConfiguration: "Luftflödeskonfiguration", defaultHint: "Rekommenderat standardvärde för vald installation.", orientation: "Luftflödesriktning", upperAccess: "Åtkomst ovanifrån", lowerAccess: "Åtkomst underifrån", frontAccess: "Åtkomst framifrån", accessPanel: "Åtkomstpanel",
...
const buildUiMessages = (
  ...
  return {
    ...
    installation: {
      ...
      upperAccess: text.upperAccess,
      lowerAccess: text.lowerAccess,
      frontAccess: text.frontAccess,
