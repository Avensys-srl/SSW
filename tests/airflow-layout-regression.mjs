...
assert.ok(styles.includes('.connection-osc.installation-floor:not(.wall-east-west):not(.wall-north-south) .flow-south { bottom: calc(50% - 80px); }'));
assert.ok(styles.includes('.flow-south.exhaust { bottom: calc(50% - 65px); }'));
