...
const lexicons: Record<LanguageCode, UiLexicon> = {
  ...
  cs: {
    ...
    airflowConfiguration: "Konfigurace proudění", defaultHint: "Doporučené výchozí nastavení pro zvolenou instalaci.", orientation: "Směr proudění", lowerAccess: "Přístup zespodu", accessPanel: "Servisní panel",
