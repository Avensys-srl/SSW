...
- ST configurations with at least one rear port show a localized dashed-grey-circle key below the airflow view. ST mounting views never show the optional SHK shelf-kit note.
